...
@Component({
  selector: 'cms-profit-animation-bar',
  templateUrl: './profit-animation-bar.component.html',
  styleUrls: ['./profit-animation-bar.component.scss']
})
export class ProfitAnimationBarComponent implements OnInit, AfterViewInit {
